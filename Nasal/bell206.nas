...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/bell206/state");
var engine = props.globals.getNode("sim/model/bell206/engine");
...
var turbine = props.globals.getNode("sim/model/bell206/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/bell206/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/bell206/rotor-step-deg");
